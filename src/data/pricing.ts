...
export const vehicleRegistrationCharges: RegistrationRow[] = [
  ...
  { code: "A2", category: "Small & Mid-Sized Sedan", weightClass: "1.5 – 1.75 tons", basePrice: 100.0, nfrCharges: 3.0, additionalCharges: null, totalCost: 103.0 },
  { code: "A3", category: "Large, Luxury Sedan, or Minivan", weightClass: "1.75 – 2.25 tons", basePrice: 125.0, nfrCharges: 3.0, additionalCharges: null, totalCost: 128.0 },
  ...
  { code: "A5", category: "Mid-Sized SUV or Pickup", weightClass: "1.75 – 2.25 tons", basePrice: 150.0, nfrCharges: 3.0, additionalCharges: null, totalCost: 153.0 },
  { code: "A6", category: "Large, Heavy Duty SUV or Pickup", weightClass: "2.25 – 4.25 tons", basePrice: 200.0, nfrCharges: 3.0, additionalCharges: null, totalCost: 203.0 },
  { code: "B1", category: "Mini Bus", weightClass: "<3.75 tons", basePrice: 200.0, nfrCharges: 6.0, additionalCharges: null, totalCost: 206.0 },
  { code: "B2", category: "Passenger Bus", weightClass: "3.75 – 5 tons", basePrice: 250.0, nfrCharges: 6.0, additionalCharges: null, totalCost: 256.0 },
  { code: "B3", category: "Large Passenger Bus", weightClass: "5 – 12 tons", basePrice: 300.0, nfrCharges: 6.0, additionalCharges: null, totalCost: 306.0 },
  { code: "B4", category: "Articulated Bus, Double-Decker, or Motor Coach", weightClass: "12 – 18 tons", basePrice: 400.0, nfrCharges: 6.0, additionalCharges: null, totalCost: 406.0 },
  ...
  { code: "B2", category: "Passenger Bus", weightClass: "3.75 – 5 tons", publicTransport: true, basePrice: 150.0, nfrCharges: 6.0, additionalCharges: null, totalCost: 156.0 },
  { code: "B3", category: "Large Passenger Bus", weightClass: "5 – 12 tons", publicTransport: true, basePrice: 150.0, nfrCharges: 6.0, additionalCharges: null, totalCost: 156.0 },
  ...
  { code: "C2", category: "Cargo — Small Cargo Vehicle", weightClass: "1.5 – 3 tons", basePrice: 200.0, nfrCharges: 9.0, additionalCharges: null, totalCost: 209.0 },
  { code: "C3", category: "Cargo — Mid-Sized Cargo Vehicle", weightClass: "3 – 4.5 tons", basePrice: 300.0, nfrCharges: 9.0, additionalCharges: null, totalCost: 309.0 },
  { code: "C4", category: "Cargo — Full-Sized Cargo Vehicle", weightClass: "4.5 – 6 tons", basePrice: 400.0, nfrCharges: 9.0, additionalCharges: null, totalCost: 409.0 },
  { code: "C5", category: "Cargo — Large Cargo Vehicle", weightClass: "6 – 8 tons", basePrice: 500.0, nfrCharges: 9.0, additionalCharges: null, totalCost: 509.0 },
  ...
  { code: "—", category: "Trailer — Light Duty — Small Utility & Tow Dolly Class 2", weightClass: "45 – 75 sq.ft.", basePrice: 50.0, nfrCharges: null, additionalCharges: null, totalCost: 50.0 },
  ...
  { code: "—", category: "Trailer — Light Duty — Small Cargo Class 2", weightClass: "230 – 400 cu.ft.", basePrice: 50.0, nfrCharges: null, additionalCharges: null, totalCost: 50.0 },
...
export const vehicleTowingCharges: TowingRow[] = [
  { vehicleType: "Motorcycle (250cc – 400cc+)", vehicleCategoryCodes: ["M1", "M2", "M3"], upTo25MilesUsd: 20.0, additionalMileRateUsd: 1.0 },
  ...
  { vehicleType: "Mid-sized Vehicle (1.5 – 3 tons)", vehicleCategoryCodes: ["A2", "A3", "A4", "A5", "A6", "C2", "B1"], upTo25MilesUsd: 150.0, additionalMileRateUsd: 1.0 },
  { vehicleType: "Large Vehicle (3 – 4.5 tons)", vehicleCategoryCodes: ["A6", "C3", "B1", "B2"], upTo25MilesUsd: 300.0, additionalMileRateUsd: 1.0 },
  { vehicleType: "Medium-Duty Vehicle (4.5 – 6 tons)", vehicleCategoryCodes: ["B2", "B3", "C4"], upTo25MilesUsd: 450.0, additionalMileRateUsd: 1.0 },
  { vehicleType: "Heavy-Duty Truck and Semi-Trailer (6 – 8 tons)", vehicleCategoryCodes: ["B3", "C5"], upTo25MilesUsd: 550.0, additionalMileRateUsd: 1.0 },
];

export const vehicleImpoundmentCharges: ImpoundmentRow[] = [
  { durationDays: "0 – 5 days", ratePerDayUsd: 0, notes: "No charge — grace period." },
  { durationDays: "6 – 30 days", ratePerDayUsd: 10.0 },
